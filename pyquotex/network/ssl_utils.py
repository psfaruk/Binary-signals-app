...
CIPHER_SUITE_FIREFOX = (
    # FIX (DEEP-AUDIT-2026-07-26 / F-16-02): removed DES-CBC3-SHA
    # (3DES — Sweet32 birthday attack), AES128-SHA and AES256-SHA
    # (CBC, no PFS). All deprecated by NIST.
...
CIPHER_SUITE_CHROME = (
    # FIX (DEEP-AUDIT-2026-07-26 / F-16-02): removed AES128-SHA and
    # AES256-SHA (CBC, no PFS) — deprecated by NIST.
    "TLS_AES_128_GCM_SHA256:"
    "TLS_AES_256_GCM_SHA384:"
    "TLS_CHACHA20_POLY1305_SHA256:"
    "ECDHE-ECDSA-AES128-GCM-SHA256:"

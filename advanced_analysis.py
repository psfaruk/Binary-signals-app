"""
Advanced Analysis Module — multi-candle patterns, market regime detection,
key level confluence, and statistical edge.

This module supplements candle_reaction.py with deeper analysis:
  - 10+ multi-candle reversal/continuation patterns (engulfing, stars,
    tweezer, harami, piercing, inside bar, 3-soldiers/crows)
  - Market regime classification (trend up/down, range, volatile)
    using EMA9/EMA21 + swing structure + ATR volatility
  - Key level confluence (swing highs/lows as S/R)
  - Statistical edge (Z-scores for body/range, close percentile,
    streak rarity)
...
Used by candle_reaction.predict_from_candle().
"""
import math

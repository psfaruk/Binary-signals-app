...
so:
  ...
  - Module 6 is `trend_follow` (NOT `otc_pattern`) — detects momentum
    continuation, EMA alignment, breakouts, and Dow structure. Mean-
    reversion logic is NOT used here because real markets trend harder.

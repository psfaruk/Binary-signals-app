...
#
# REAL-MARKET TUNING (2026-07-17): in real-market pairs (live exchange
# prices, real order flow), technical indicators and multi-candle
# patterns actually reflect underlying liquidity moves — they are MORE
# reliable than in OTC where the broker's algorithm often creates fake
# signals. INDICATOR tier is bumped from 1.0 → 1.3 to match STAT/LEVEL.
# OTC tier stays at 1.2 (the OTC module still fires on real pairs when
# broker behavior mimics OTC patterns — same code path).
RELIABILITY = {
